...
void RayTracingRendering::updateRenderPass() {
...
void RayTracingRendering::enableExtensions() {
	// Require Vulkan 1.1
...
RayTracingRendering::ScratchBuffer RayTracingRendering::createScratchBuffer(VkDeviceSize size) {
...
void RayTracingRendering::deleteScratchBuffer(ScratchBuffer& scratchBuffer) {
...
uint64_t RayTracingRendering::getBufferDeviceAddress(VkBuffer buffer) {
...
void RayTracingRendering::createStorageImage(VkFormat format, VkExtent3D extent) {
...
void RayTracingRendering::deleteStorageImage() {
...
void RayTracingRendering::prepare() {
	VulkanBase::prepare();
...
VkStridedDeviceAddressRegionKHR RayTracingRendering::getSbtEntryStridedDeviceAddressRegion(VkBuffer buffer, uint32_t handleCount) {
...
void RayTracingRendering::createShaderBindingTable(ShaderBindingTable& shaderBindingTable, uint32_t handleCount) {
...
void RayTracingRendering::drawUI(VkCommandBuffer commandBuffer, VkFramebuffer framebuffer) {
	...
	VulkanBase::drawUI(commandBuffer);
